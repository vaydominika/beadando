...
export default function Modal({ isOpen, onClose, title, children }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      <div 
        className="relative bg-white rounded-lg shadow-[0_8px_0_0_#e5e7eb] border border-gray-200 w-full max-w-2xl max-h-[90vh] overflow-auto z-10 animate-[modal-pop_0.4s_cubic-bezier(0.16,1,0.3,1)_forwards]"
